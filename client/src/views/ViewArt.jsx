    ...
    <div class="section_our_solution">
        ...
        <div class="our_solution_category">
            ...
            <div class="solution_card">
                ...
                <img style ={{marginTop:"20px", marginBottom: "20px"}} src={`${articles[id].image}`} height="350px" width="700px"/>
               
                <a  href={articles[id].url} target="_blank"><button type="button" class="read_more_btn">Read From the Orignal Source</button></a>
